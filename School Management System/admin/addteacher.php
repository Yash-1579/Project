...
<body>
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="text-white text-center bg-primary">Add Teacher</h2>
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Enter Teacher Name"
                                        name="teacherName" required style="border: 1px solid black;padding:10px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Enter Address Here"
                                        name="address" required style="border: 1px solid black;padding:10px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="medium" required
                                        ...
                                        <option value="Semi">Hindi</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Enter Mobile Here"
                                        name="mobile" required style="border: 1px solid black;padding:10px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Enter Total Salary Here"
                                        name="salary" required style="border: 1px solid black;padding:10px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Enter Password Here"
                                        name="password" required style="border: 1px solid black;padding:10px;">
                                </div>
                            </div>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="checkbox" name="com[]"
                                                value="<?php echo $examName;?>"> <?php echo $examName;?>
                                        </label>
                                    </div>
                                    <?php } ?>
                                </div>
  ...
  if(isset($_POST['submit'])){
    ...
    //   $com = implode(",",$_POST['com']); 
      ...
      (name,address,class,batch,medium,gender,mobile,email,salary,password,dob,image,date)
      VALUES ('$teacherName','$address','$class','$batch','$medium','$gender','$mobile','$email','$salary','$password','$date','$u_image',NOW())";
