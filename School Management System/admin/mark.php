...
if(isset($_GET['del'])){
    ...
    $del_query = "DELETE  FROM result WHERE studentId = '$del_id'";
...
<body>
    ...
    <table class="table table-bordered display" id="table2excel">
        ...
        <tbody>
            ...
            <td><a href="mark.php?del=<?php echo $id;?>" class="btn btn-danger"><i
                                                    class="fa fa-trash-o" aria-hidden="true"></i></a></td> </tr>
           </tbody>
