            ...
            <div class="col-md-9">
                ...
                ?>
                                    <tr>
                                        ...
                                        <td><img src="../images/student/<?php echo $image;?>" class="img-fluid"
                                                width="100px"></td>
                                        <td><a href="studentDetails.php?id=<?php echo $id;?>" class="btn btn-primary"><i
                                                    class="fa fa-eye" aria-hidden="true"></i></a></td>

                                        <td><a href="editStudent.php?id=<?php echo $id;?>" class="btn btn-warning"><i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>

                                        <td><a href="student.php?del=<?php echo $id;?>" class="btn btn-danger"><i
