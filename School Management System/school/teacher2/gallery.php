            ...
            <div class="col-md-9">
                ...
                ?>
                                    <tr>
                                        ...
                                        <td><img src="../images/gallery/<?php echo $gallery_image;?>"
                                                class="img-fluid shadow-bold" width="100px;"></td>
                                        <!-- <td>
                                            <a href="editGallery.php?id=<?php echo $gallery_id;?>"
                                                class="btn btn-warning"><i class="fa fa-pencil-square-o"
                                                    aria-hidden="true"></i></a>
                                        </td>
                                        <td><a href="gallery.php?del=<?php echo $gallery_id;?>"
