    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-top:10px;">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center bg-secondary text-white">View all Teacher</h1>
                        <div align="right">
                            <a href="addteacher.php" class="btn btn-outline-primary">Add Teacher</a>
                            <hr>
                        </div>
                ...
                ?>
                                    <tr>
                                        ...
                                        <td><img src="../images/Teacher/<?php echo $image;?>" class="img-fluid"
                                                width="100px"></td>
                                        <td><a href="teacherdetails.php?id=<?php echo $id;?>" class="btn btn-primary"><i
                                                    class="fa fa-eye" aria-hidden="true"></i></a></td>

                                        <td><a href="editteacher.php?id=<?php echo $id;?>" class="btn btn-warning"><i
                                                    class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>

                                        <td><a href="teacher.php?del=<?php echo $id;?>" class="btn btn-danger"><i
